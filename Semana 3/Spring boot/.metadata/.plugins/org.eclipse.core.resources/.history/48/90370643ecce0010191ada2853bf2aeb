...
public class ImplementacionEmpleado implements EmpleadoService {
	...
	@Override
	public Empleado searchEmpleado(Empleado idEmpleado) {
		return empleadoDao.findById(idEmpleado.getIdEmpleado()).orElse(null); //Busca un empleado por su ID en la base de datos utilizando el repositorio DAO
