...
public class FuncionImplementacion implements FuncionServicio {
	...
	//Método personalizado para verificar si existe una función por película y horarios
	public boolean existeFuncion(String pelicula, String horarios) {
		return funcionDao.existsByPeliculaAndHorariosAllIgnoreCase(pelicula, horarios);
	}
