...
export class Servidor {
  ...
  guardarTiendas(tienda: Tienda): Observable<HttpResponse<Tienda>> {
    return this.http.post<Tienda>(this.url + 'tiendas/guardar/', tienda, { observe: 'response' });
  }
  ...
  eliminarTiendas(id: number): Observable<HttpResponse<void>> {
  ...
  guardarProductos(producto: Producto): Observable<HttpResponse<Producto>> {
    return this.http.post<Producto>(this.url + 'productos/guardar/', producto, { observe: 'response' });
  }
  ...
  eliminarProductos(id: number): Observable<HttpResponse<void>> {
    return this.http.delete<void>(this.url + 'productos/eliminar/' + id, { observe: 'response' });
  }

  //Metodo para buscar productos por id
  buscarProductoId(id: number): Observable<HttpResponse<Producto>> {
    return this.http.get<Producto>(this.url + 'productos/buscar/' + id, { observe: 'response' });
  }
  ...
  guardarClientes(cliente: Cliente): Observable<HttpResponse<Cliente>> {
    return this.http.post<Cliente>(this.url + 'clientes/guardar/', cliente, { observe: 'response' });
  }
  ...
  //Colocamos el void por que en el backend no nos regresa un cuerpo
  eliminarClientes(id: number): Observable<HttpResponse<void>> {
    return this.http.delete<void>(this.url + 'clientes/eliminar/' + id, { observe: 'response' });
  }

  buscarClienteId(id: number): Observable<HttpResponse<Cliente>> {
    return this.http.get<Cliente>(this.url + 'clientes/' + id, { observe: 'response' });
  }
  ...
  guardarDepartamentos(departamento: Departamento): Observable<HttpResponse<Departamento>> {
    return this.http.post<Departamento>(this.url + 'departamento/guardar/', departamento, { observe: 'response' });
  }
  ...
  //Colocamos el void por que en el backend no nos regresa un cuerpo
  eliminarDepartamentos(id: number): Observable<HttpResponse<void>> {
    return this.http.delete<void>(this.url + 'departamento/eliminar/' + id, { observe: 'response' });
  }

  buscarDepartamentoId(id: number): Observable<HttpResponse<Departamento>> {
    return this.http.get<Departamento>(this.url + 'departamento/buscar/' + id, { observe: 'response' });
  }
  ...
  guardarEmpleados(empleado: Empleado): Observable<HttpResponse<Empleado>> {
    return this.http.post<Empleado>(this.url + 'empleados/guardar/', empleado, { observe: 'response' });
  }
  ...
  eliminarEmpleados(id: number): Observable<HttpResponse<void>> {
    return this.http.delete<void>(this.url + 'empleados/eliminar/' + id, { observe: 'response' });
  }

  buscarEmpleadoId(id: number): Observable<HttpResponse<Empleado>> {
    return this.http.get<Empleado>(this.url + 'empleados/buscar/' + id, { observe: 'response' });
  }
  ...
  guardarProveedores(proveedor: Proveedores): Observable<HttpResponse<Proveedores>> {
    return this.http.post<Proveedores>(this.url + 'proveedores/guardar/', proveedor, { observe: 'response' });
  }
  ...
  //Colocamos el void por que en el backend no nos regresa un cuerpo
  eliminarProveedores(id: number): Observable<HttpResponse<void>> {
    return this.http.delete<void>(this.url + 'proveedores/eliminar/' + id, { observe: 'response' });
  }

  buscarProveedorId(id: number): Observable<HttpResponse<Proveedores>> {
    return this.http.get<Proveedores>(this.url + 'proveedores/buscar/' + id, { observe: 'response' });
  }
}
